    ...
    while queue and steps_taken < max_steps:
        ...
        for act in legal_actions:
            ...
            if (
                ...
                or act_id.startswith("craft_")
                or act_id.startswith("calamity_")
                or act_id.startswith("codex_")
                or act_id.startswith("transit_")
                or act_id.startswith("trade_")
                or act_id.startswith("weather_")
                or act_id.startswith("bounty_")
                or act_id.startswith("companion_")
                or act_id.startswith("bestiary_")
                or act_id.startswith("survival_")
                or act_id.startswith("order_")
                or act_id.startswith("heraldry_")
                or act_id.startswith("shrine_")
                or act_id.startswith("landmark_")
                or act_id.startswith("vault_")
                or act_id.startswith("forge_")
                or act_id.startswith("elixir_")
                or act_id.startswith("orrery_")
                or act_id.startswith("scribe_")
            ):
                continue
