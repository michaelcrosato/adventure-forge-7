...
def build_high_court_province() -> RegionManifest:
    ...
    scenes["high_court_hub"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="court_resolve_royalist", label="Crown Malor Regent", category="social", condition={"all_of": [{"flag_is": {"flag": "court_dilemma_resolved", "value": True}}, {"flag_is": {"flag": "court_ruling_crown", "value": True}}, {"lacks_flag": "court_intrigue_resolved"}]}, effects=[{"set_flag": {"flag": "court_intrigue_resolved", "value": True}}, {"set_flag": {"flag": "court_ending_royalist", "value": True}}, {"modify_reputation": {"faction": "crown_royalists", "value": 35}}, {"modify_reputation": {"faction": "dukes_conclave", "value": -25}}, {"modify_reputation": {"faction": "guild_emissaries", "value": -20}}, {"add_marker": "imperial_justiciar"}, {"log_event": "You crowned Arch-Justiciar Malor as imperial regent."}], result_text="You proclaim imperial martial law. Knight-Palatines arrest the conspirators."),
            Action(id="court_resolve_ducal", label="Seat Duke Cassian", category="social", condition={"all_of": [{"flag_is": {"flag": "court_dilemma_resolved", "value": True}}, {"flag_is": {"flag": "court_ruling_duke", "value": True}}, {"lacks_flag": "court_intrigue_resolved"}]}, effects=[{"set_flag": {"flag": "court_intrigue_resolved", "value": True}}, {"set_flag": {"flag": "court_ending_ducal", "value": True}}, {"modify_reputation": {"faction": "dukes_conclave", "value": 35}}, {"modify_reputation": {"faction": "crown_royalists", "value": -30}}, {"add_marker": "ducal_patron"}, {"log_event": "You installed Duke Cassian and ratified noble autonomy."}] ,result_text="You seat Duke Cassian upon the dais. Provincial barons cheer their new autonomy."),
            Action(id="court_resolve_guild", label="Empower Trade Guild", category="social", condition={"all_of": [{"flag_is": {"flag": "court_dilemma_resolved", "value": True}}, {"flag_is": {"flag": "court_ruling_guild", "value": True}}, {"lacks_flag": "court_intrigue_resolved"}]}, effects=[{"set_flag": {"flag": "court_intrigue_resolved", "value": True}}, {"set_flag": {"flag": "court_ending_guild", "value": True}}, {"modify_reputation": {"faction": "guild_emissaries", "value": 35}}, {"modify_reputation": {"faction": "crown_royalists", "value": -20}}, {"modify_reputation": {"faction": "dukes_conclave", "value": -20}}, {"add_marker": "guild_consul"}, {"log_event": "You ratified the Grand Mercantile Charter."}], result_text="You sign the trade charter. Merchant syndicates take control of provincial commerce."),
            Action(id="court_resolve_regent", label="Proclaim Commoner Rule", category="social", condition={"all_of": [{"flag_is": {"flag": "court_dilemma_resolved", "value": True}}, {"flag_is": {"flag": "court_ruling_regent", "value": True}}, {"lacks_flag": "court_intrigue_resolved"}]}, effects=[{"set_flag": {"flag": "court_intrigue_resolved", "value": True}}, {"set_flag": {"flag": "court_ending_regent", "value": True}}, {"modify_reputation": {"faction": "commoners", "value": 35}}, {"modify_reputation": {"faction": "crown_royalists", "value": 15}}, {"modify_reputation": {"faction": "dukes_conclave", "value": -15}}, {"modify_reputation": {"faction": "guild_emissaries", "value": -15}}, {"add_marker": "lord_regent"}, {"log_event": "You seized the Regency Bench in the name of the common people."}], result_text="You claim the regency bench. Commoners cheer in the plaza below your balcony."),
    ...
    scenes["high_court_justiciar_hall_gate"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="court_present_bailiff_warrants", label="Present Bailiff Warrants", category="social", condition={"any_of": [{"min_reputation": {"faction": "river_guild", "value": 15}}, {"min_reputation": {"faction": "city_watch", "value": 15}}, {"has_marker": "high_bailiff"}, {"has_marker": "river_bailiff"}]}, effects=[{"set_flag": {"flag": "court_tribunal_fast_track", "value": True}}, {"modify_reputation": {"faction": "crown_royalists", "value": 10}}, {"log_event": "High Justiciars admitted your municipal warrants without delay."}], result_text="Justiciars inspect your municipal seals. They grant you immediate access to the tribunal chamber."),
    ...
    scenes["high_court_justiciar_hall_quarters"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="court_tribunal_back_crown", label="Present Sovereign Scroll", category="social", condition={"all_of": [{"flag_is": {"flag": "court_escalation_completed", "value": True}}, {"lacks_flag": "court_dilemma_resolved"}]}, effects=[{"set_flag": {"flag": "court_ruling_crown", "value": True}}, {"set_flag": {"flag": "court_dilemma_resolved", "value": True}}, {"modify_reputation": {"faction": "crown_royalists", "value": 20}}, {"modify_reputation": {"faction": "dukes_conclave", "value": -15}}, {"log_event": "You presented evidence supporting Crown Royalist sovereignty."}], result_text="You present the royal scroll. Arch-Justiciar Malor bangs his gavel and orders arrests."),
            Action(id="court_tribunal_back_duke", label="Expose Royal Fraud", category="social", condition={"all_of": [{"flag_is": {"flag": "court_escalation_completed", "value": True}}, {"lacks_flag": "court_dilemma_resolved"}]}, effects=[{"set_flag": {"flag": "court_ruling_duke", "value": True}}, {"set_flag": {"flag": "court_dilemma_resolved", "value": True}}, {"modify_reputation": {"faction": "dukes_conclave", "value": 20}}, {"modify_reputation": {"faction": "crown_royalists", "value": -15}}, {"log_event": "You exposed the broken succession and supported Duke Cassian."}], result_text="You present the altered vellum. The assembly roars as Duke Cassian claims the floor."),
            Action(id="court_tribunal_back_guild", label="Ratify Trade Treaty", category="social", condition={"all_of": [{"flag_is": {"flag": "court_escalation_completed", "value": True}}, {"lacks_flag": "court_dilemma_resolved"}]}, effects=[{"set_flag": {"flag": "court_ruling_guild", "value": True}}, {"set_flag": {"flag": "court_dilemma_resolved", "value": True}}, {"modify_reputation": {"faction": "guild_emissaries", "value": 20}}, {"modify_reputation": {"faction": "crown_royalists", "value": -10}}, {"log_event": "You forced ratification of the Grand Mercantile Charter."}], result_text="You table the embargo ciphers. The judges capitulate and ratify the trade treaty."),
            Action(id="court_tribunal_seize_bench", label="Seize The Regency", category="trait_exploit", condition={"all_of": [{"flag_is": {"flag": "court_escalation_completed", "value": True}}, {"lacks_flag": "court_dilemma_resolved"}, {"any_of": [{"min_skill": {"skill": "rhetoric", "value": 4}}, {"min_attribute": {"attribute": "intimidation", "value": 14}}, {"has_item": "chancellor_signet_ring"}]}]}, effects=[{"set_flag": {"flag": "court_ruling_regent", "value": True}}, {"set_flag": {"flag": "court_dilemma_resolved", "value": True}}, {"modify_reputation": {"faction": "commoners", "value": 25}}, {"modify_reputation": {"faction": "crown_royalists", "value": 10}}, {"log_event": "You seized the High Regency bench in your own name."}], result_text="You step upon the high judicial rostrum. Both lords and bailiffs bow before your command."),
    ...
    scenes["high_court_royal_archive_gate"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="court_bribe_lowlands_clerk", label="Bribe Court Clerk", category="social", condition={"any_of": [{"min_reputation": {"faction": "shadow_syndicate", "value": 15}}, {"min_reputation": {"faction": "smugglers", "value": 15}}, {"has_marker": "syndicate_kingpin"}, {"has_marker": "syndicate_contact"}]}, effects=[{"set_flag": {"flag": "archive_grille_unlocked", "value": True}}, {"set_flag": {"flag": "court_clerk_bribed", "value": True}}, {"log_event": "You bribed the royal court archivist using Lowlands syndicate gold."}], result_text="You bribe the court clerk with canal gold. He unlocks the justice archive chamber."),
    ...
    scenes["high_court_royal_archive_courtyard"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="court_archive_search_stacks", label="Search Restricted Shelf", category="interaction", condition={"all_of": [{"lacks_flag": "court_discovery_completed"}, {"any_of": [{"min_skill": {"skill": "cunning", "value": 3}}, {"has_item": "lockpick"}, {"has_trait": "skeptical"}, {"background_is": "noble_exile"}]}]}, effects=[{"set_flag": {"flag": "court_archive_evidence_found", "value": True}}, {"set_flag": {"flag": "court_discovery_completed", "value": True}}, {"add_item": "sovereign_lineage_scroll"}, {"modify_reputation": {"faction": "crown_royalists", "value": 5}}, {"log_event": "You uncovered altered dynastic records on the restricted shelf."}], result_text="You pick the bronze grille. An ancient scroll reveals erased royal names."),
    ...
    scenes["high_court_knight_barracks_courtyard"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="court_barracks_sway_knights", label="Defuse Palatine Standoff", category="social", condition={"all_of": [{"flag_is": {"flag": "court_discovery_completed", "value": True}}, {"lacks_flag": "court_escalation_completed"}, {"any_of": [{"min_skill": {"skill": "rhetoric", "value": 3}}, {"background_is": "noble_exile"}, {"has_trait": "skeptical"}]}]}, effects=[{"set_flag": {"flag": "court_knights_won_to_duke", "value": True}}, {"set_flag": {"flag": "court_escalation_completed", "value": True}}, {"modify_reputation": {"faction": "dukes_conclave", "value": 15}}, {"modify_reputation": {"faction": "crown_royalists", "value": -15}}, {"log_event": "You defused the palatine standoff and won knight loyalty for the Duke."}], result_text="You address the assembled knights. The palatines lower their swords and honor the Conclave."),
    ...
    scenes["high_court_diplomat_lounge_courtyard"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="court_salon_eavesdrop_envoy", label="Intercept Trade Courier", category="social", condition={"all_of": [{"lacks_flag": "court_discovery_completed"}, {"any_of": [{"min_skill": {"skill": "stealth", "value": 3}}, {"min_skill": {"skill": "rhetoric", "value": 3}}, {"has_trait": "light_fingers"}, {"background_is": "cutpurse"}]}]}, effects=[{"set_flag": {"flag": "court_guild_ledger_found", "value": True}}, {"set_flag": {"flag": "court_discovery_completed", "value": True}}, {"add_item": "guild_embargo_ciphers"}, {"modify_reputation": {"faction": "guild_emissaries", "value": 5}}, {"log_event": "You intercepted Envoy Laurent's secret trade embargo ciphers."}], result_text="You intercept the courier satchel. Secret papers detail a planned grain embargo."),
    ...
    scenes["high_court_diplomat_lounge_quarters"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="court_salon_finance_bribe", label="Buy Grain Relief", category="social", condition={"all_of": [{"flag_is": {"flag": "court_discovery_completed", "value": True}}, {"lacks_flag": "court_escalation_completed"}, {"any_of": [{"has_item": "silver_coin"}, {"has_item": "smuggler_bounty_purse"}, {"min_skill": {"skill": "rhetoric", "value": 3}}]}]}, effects=[{"set_flag": {"flag": "court_guild_bargain_struck", "value": True}}, {"set_flag": {"flag": "court_escalation_completed", "value": True}}, {"modify_reputation": {"faction": "guild_emissaries", "value": 20}}, {"modify_reputation": {"faction": "commoners", "value": 15}}, {"log_event": "You bought out the grain embargo contract to feed the city."}], result_text="You trade silver for grain relief. Merchant barges release food stores to the common folk."),
    ...
    scenes["high_court_silver_vault_gate"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="court_vault_pick_sluice", label="Pick Treasury Grate", category="interaction", condition={"all_of": [{"flag_is": {"flag": "court_discovery_completed", "value": True}}, {"lacks_flag": "court_escalation_completed"}, {"any_of": [{"has_item": "lockpick"}, {"min_skill": {"skill": "cunning", "value": 4}}, {"has_trait": "light_fingers"}]}]}, effects=[{"set_flag": {"flag": "court_vault_exposed", "value": True}}, {"set_flag": {"flag": "court_escalation_completed", "value": True}}, {"add_item": "ducal_conspiracy_ledger"}, {"modify_reputation": {"faction": "crown_royalists", "value": 15}}, {"modify_reputation": {"faction": "dukes_conclave", "value": -15}}, {"log_event": "You picked the treasury grate and seized Duke Cassian's gold ledger."}], result_text="You pick the bronze lock. Inside, a secret ledger records illegal bullion shipments."),
