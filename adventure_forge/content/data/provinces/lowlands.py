...
def build_lowlands_province() -> RegionManifest:
    ...
    scenes["lowlands_hub"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="lowlands_broker_end_ally", label="Form shadow pact", category="interaction", condition={"flag_is": {"flag": "lowlands_cipher_decoded", "value": True}, "lacks_flag": "lowlands_broker_resolved"}, effects=[{"set_flag": {"flag": "lowlands_broker_resolved", "value": True}}, {"set_flag": {"flag": "lowlands_broker_allied", "value": True}}, {"modify_reputation": {"faction": "shadow_syndicate", "value": 25}}, {"log_event": "You partnered with the Shadow Broker."}], result_text="The broker offers you equal share in harbor smuggling."),
            Action(id="lowlands_broker_end_expose", label="Expose the broker", category="interaction", condition={"flag_is": {"flag": "lowlands_cipher_decoded", "value": True}, "lacks_flag": "lowlands_broker_resolved"}, effects=[{"set_flag": {"flag": "lowlands_broker_resolved", "value": True}}, {"set_flag": {"flag": "lowlands_broker_exposed", "value": True}}, {"modify_reputation": {"faction": "city_watch", "value": 25}}, {"log_event": "You handed the broker to the City Watch."}], result_text="City watchmen storm the cellar and arrest the broker."),
            Action(id="lowlands_broker_end_usurp", label="Seize the ring", category="interaction", condition={"flag_is": {"flag": "lowlands_cipher_decoded", "value": True}, "lacks_flag": "lowlands_broker_resolved"}, effects=[{"set_flag": {"flag": "lowlands_broker_resolved", "value": True}}, {"set_flag": {"flag": "lowlands_broker_usurped", "value": True}}, {"log_event": "You overthrew the broker and claimed the syndicate."}], result_text="You cut down the broker and rule the cellar yourself."),
    ...
    scenes["lowlands_canal_sluice_chamber"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="lowlands_sluice_sabotage_winch", label="Jam Sluice Winch", category="systemic", condition={"all_of": [{"flag_is": {"flag": "lowlands_manifest_decided", "value": True}}, {"lacks_flag": "lowlands_sluice_decided"}]}, effects=[{"set_flag": {"flag": "lowlands_sluice_decided", "value": True}}, {"set_flag": {"flag": "lowlands_sluice_jammed", "value": True}}, {"modify_reputation": {"faction": "shadow_syndicate", "value": 15}}, {"log_event": "You jammed the canal sluice gears to allow smuggler night barges through."}], result_text="You jam iron wedges into the sluice gears. Contraband barges slip past unnoticed."),
            Action(id="lowlands_sluice_lock_chains", label="Lock Sluice Chains", category="systemic", condition={"all_of": [{"flag_is": {"flag": "lowlands_manifest_decided", "value": True}}, {"lacks_flag": "lowlands_sluice_decided"}]}, effects=[{"set_flag": {"flag": "lowlands_sluice_decided", "value": True}}, {"set_flag": {"flag": "lowlands_sluice_locked", "value": True}}, {"modify_reputation": {"faction": "river_guild", "value": 15}}, {"log_event": "You locked down the heavy sluice chains to intercept smuggler vessels."}], result_text="You drop the heavy sluice gate into place. The iron chain holds fast against skiffs."),
            Action(id="lowlands_sluice_rig_bypass", label="Rig Sluice Bypass", category="trait_exploit", condition={"all_of": [{"flag_is": {"flag": "lowlands_manifest_decided", "value": True}}, {"lacks_flag": "lowlands_sluice_decided"}, {"min_skill": {"skill": "cunning", "value": 3}}]}, effects=[{"set_flag": {"flag": "lowlands_sluice_decided", "value": True}}, {"set_flag": {"flag": "lowlands_sluice_bypassed", "value": True}}, {"modify_reputation": {"faction": "shadow_syndicate", "value": 15}}, {"modify_reputation": {"faction": "river_guild", "value": 15}}, {"log_event": "You rigged a counterweight bypass that obeys custom signal chimes."}], result_text="You balance counterweights behind masonry. The gate obeys your secret signal."),
    ...
    scenes["lowlands_bell_tower_overlook"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="lowlands_bell_signal_syndicate", label="Signal Shadow Fleet", category="interaction", condition={"all_of": [{"flag_is": {"flag": "lowlands_sluice_decided", "value": True}}, {"lacks_flag": "lowlands_river_intrigue_resolved"}]}, effects=[{"set_flag": {"flag": "lowlands_river_intrigue_resolved", "value": True}}, {"set_flag": {"flag": "lowlands_intrigue_syndicate_win", "value": True}}, {"modify_reputation": {"faction": "shadow_syndicate", "value": 30}}, {"modify_reputation": {"faction": "river_guild", "value": -25}}, {"log_event": "You signaled the shadow fleet to storm the river harbor."}], result_text="Lantern flashes reply across dark water. Armed smuggler crews seize the wharves."),
            Action(id="lowlands_bell_ring_alarm", label="Ring Harbor Bell", category="interaction", condition={"all_of": [{"flag_is": {"flag": "lowlands_sluice_decided", "value": True}}, {"lacks_flag": "lowlands_river_intrigue_resolved"}]}, effects=[{"set_flag": {"flag": "lowlands_river_intrigue_resolved", "value": True}}, {"set_flag": {"flag": "lowlands_intrigue_guild_win", "value": True}}, {"modify_reputation": {"faction": "river_guild", "value": 30}}, {"modify_reputation": {"faction": "shadow_syndicate", "value": -25}}, {"log_event": "You rang the heavy cathedral bell, summoning the river garrison."}], result_text="The great brass bell peals across fog. Armored bailiffs arrest the smugglers."),
            Action(id="lowlands_bell_sign_compact", label="Sign River Compact", category="social", condition={"all_of": [{"flag_is": {"flag": "lowlands_sluice_decided", "value": True}}, {"lacks_flag": "lowlands_river_intrigue_resolved"}, {"any_of": [{"min_skill": {"skill": "rhetoric", "value": 3}}, {"has_marker": "syndicate_contact"}]}]}, effects=[{"set_flag": {"flag": "lowlands_river_intrigue_resolved", "value": True}}, {"set_flag": {"flag": "lowlands_intrigue_compact_win", "value": True}}, {"modify_reputation": {"faction": "shadow_syndicate", "value": 20}}, {"modify_reputation": {"faction": "river_guild", "value": 20}}, {"log_event": "You negotiated a clandestine toll sharing compact between both factions."}], result_text="Representatives sign the secret treaty upon the windy bell parapet."),
    ...
    scenes["lowlands_customs_house_quarters"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="lowlands_manifest_give_syndicate", label="Deliver To Smugglers", category="social", condition={"lacks_flag": "lowlands_manifest_decided"}, effects=[{"set_flag": {"flag": "lowlands_manifest_decided", "value": True}}, {"set_flag": {"flag": "lowlands_manifest_syndicate", "value": True}}, {"add_marker": "syndicate_contact"}, {"modify_reputation": {"faction": "shadow_syndicate", "value": 20}}, {"modify_reputation": {"faction": "river_guild", "value": -15}}, {"log_event": "You delivered the unredacted customs ledger to the Shadow Syndicate."}], result_text="The syndicate broker nods in approval and grants you safe passage."),
            Action(id="lowlands_manifest_give_bailiff", label="Deliver To Bailiff", category="social", condition={"lacks_flag": "lowlands_manifest_decided"}, effects=[{"set_flag": {"flag": "lowlands_manifest_decided", "value": True}}, {"set_flag": {"flag": "lowlands_manifest_bailiff", "value": True}}, {"add_marker": "river_bailiff"}, {"modify_reputation": {"faction": "river_guild", "value": 20}}, {"modify_reputation": {"faction": "shadow_syndicate", "value": -15}}, {"log_event": "You handed over the customs manifest to the River Guild bailiff."}], result_text="The bailiff stamps your credentials and enters the contraband warrants."),
            Action(id="lowlands_manifest_forge_twin", label="Forge Twin Ledgers", category="trait_exploit", condition={"all_of": [{"lacks_flag": "lowlands_manifest_decided"}, {"any_of": [{"min_skill": {"skill": "cunning", "value": 3}}, {"min_skill": {"skill": "rhetoric", "value": 3}}]}]}, effects=[{"set_flag": {"flag": "lowlands_manifest_decided", "value": True}}, {"set_flag": {"flag": "lowlands_manifest_forged", "value": True}}, {"add_marker": "syndicate_contact"}, {"add_marker": "river_bailiff"}, {"modify_reputation": {"faction": "shadow_syndicate", "value": 15}}, {"modify_reputation": {"faction": "river_guild", "value": 15}}, {"log_event": "You forged duplicate customs manifests to deceive both factions."}], result_text="You alter the wax seals skillfully. Both factions accept your doctored copies."),
    ...
    scenes["lowlands_customs_house_vault"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="lowlands_steal_cipher", label="Steal cargo ledger", category="interaction", condition={"flag_is": {"flag": "lowlands_informant_contacted", "value": True}, "lacks_flag": "lowlands_cipher_decoded"}, effects=[{"set_flag": {"flag": "lowlands_cipher_decoded", "value": True}}, {"log_event": "You deciphered the secret shipping codes."}], result_text="You decode the clandestine routes of the Shadow Broker."),
