...
def build_reach_province() -> RegionManifest:
    ...
    scenes["reach_hub"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="reach_resolve_warden_dominance", label="Pact With Wardens", category="social", condition={"all_of": [{"flag_is": {"flag": "reach_dilemma_resolved", "value": True}}, {"flag_is": {"flag": "reach_diverted_to_gorge", "value": True}}, {"lacks_flag": "reach_intrigue_resolved"}]}, effects=[{"set_flag": {"flag": "reach_intrigue_resolved", "value": True}}, {"set_flag": {"flag": "reach_ending_warden", "value": True}}, {"modify_reputation": {"faction": "storm_wardens", "value": 30}}, {"modify_reputation": {"faction": "cliff_clans", "value": -30}}, {"modify_reputation": {"faction": "iron_guard", "value": 15}}, {"add_marker": "storm_vow"}, {"log_event": "You ratified the Lightning Aegis with the Storm Wardens."}], result_text="You swear the storm vow. The Wardens raise electrical wards over the mountain pass."),
            Action(id="reach_resolve_clan_liberation", label="Pact With Clans", category="social", condition={"all_of": [{"flag_is": {"flag": "reach_dilemma_resolved", "value": True}}, {"flag_is": {"flag": "reach_spire_ground_shorted", "value": True}}, {"lacks_flag": "reach_intrigue_resolved"}]}, effects=[{"set_flag": {"flag": "reach_intrigue_resolved", "value": True}}, {"set_flag": {"flag": "reach_ending_clan", "value": True}}, {"modify_reputation": {"faction": "cliff_clans", "value": 30}}, {"modify_reputation": {"faction": "storm_wardens", "value": -30}}, {"modify_reputation": {"faction": "smugglers", "value": 20}}, {"add_marker": "clan_kin"}, {"log_event": "You secured sovereign freedom for the mountain Cliff Clans."}], result_text="You ratify the clan pact. Mountaineers reclaim their stone quarries and high caves."),
            Action(id="reach_resolve_ascetic_harmony", label="Proclaim Peak Harmony", category="social", condition={"all_of": [{"flag_is": {"flag": "reach_dilemma_resolved", "value": True}}, {"flag_is": {"flag": "reach_vents_harmonized", "value": True}}, {"lacks_flag": "reach_intrigue_resolved"}]}, effects=[{"set_flag": {"flag": "reach_intrigue_resolved", "value": True}}, {"set_flag": {"flag": "reach_ending_harmony", "value": True}}, {"modify_reputation": {"faction": "storm_wardens", "value": 25}}, {"modify_reputation": {"faction": "cliff_clans", "value": 25}}, {"add_marker": "ridge_harmonizer"}, {"log_event": "You established the Granite Harmony between monks and clans."}], result_text="You announce the dual accord. Monks and clansmen join hands across the high summit."),
    ...
    scenes["reach_dunwall_fort_gate"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="reach_whistle_smuggler_call", label="Whistle Smuggler Call", category="social", condition={"any_of": [{"min_reputation": {"faction": "shadow_syndicate", "value": 15}}, {"min_reputation": {"faction": "smugglers", "value": 15}}, {"has_marker": "syndicate_kingpin"}, {"has_marker": "syndicate_contact"}]}, effects=[{"set_flag": {"flag": "dunwall_grapple_anchored", "value": True}}, {"set_flag": {"flag": "reach_smuggler_bypass_used", "value": True}}, {"log_event": "You signaled mountain smugglers who lowered an escape rope over Dunwall cliff."}], result_text="You whistle the low smuggler call at the fortress. Outlaws lower a knotted climbing rope."),
    ...
    scenes["reach_granite_mine_courtyard"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="reach_mine_storm_barricade", label="Storm The Barricade", category="systemic", condition={"all_of": [{"flag_is": {"flag": "reach_discovery_completed", "value": True}}, {"lacks_flag": "reach_escalation_completed"}, {"any_of": [{"min_attribute": {"attribute": "strength", "value": 14}}, {"min_skill": {"skill": "athletics", "value": 3}}, {"background_is": "pit_fighter"}]}]}, effects=[{"set_flag": {"flag": "reach_quarry_broken_by_force", "value": True}}, {"set_flag": {"flag": "reach_escalation_completed", "value": True}}, {"modify_reputation": {"faction": "storm_wardens", "value": 15}}, {"modify_reputation": {"faction": "cliff_clans", "value": -15}}, {"log_event": "You battered down the clan timber barricade by force."}], result_text="You smash through the timber barricade with brute force. The quarry gate yields."),
            Action(id="reach_mine_broker_truce", label="Broker Quarry Truce", category="social", condition={"all_of": [{"flag_is": {"flag": "reach_discovery_completed", "value": True}}, {"lacks_flag": "reach_escalation_completed"}, {"any_of": [{"min_skill": {"skill": "rhetoric", "value": 3}}, {"background_is": "highland_scout"}, {"has_trait": "skeptical"}]}]}, effects=[{"set_flag": {"flag": "reach_quarry_truce_brokered", "value": True}}, {"set_flag": {"flag": "reach_escalation_completed", "value": True}}, {"modify_reputation": {"faction": "cliff_clans", "value": 10}}, {"modify_reputation": {"faction": "storm_wardens", "value": 10}}, {"log_event": "You brokered a compromise running power lines along rock fissures."}], result_text="You negotiate with both sides. The monks agree to re-route cables around burial stones."),
    ...
    scenes["reach_high_pass_gate"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="reach_show_garrison_pass", label="Show Garrison Pass", category="social", condition={"any_of": [{"min_reputation": {"faction": "river_guild", "value": 15}}, {"min_reputation": {"faction": "city_watch", "value": 15}}, {"has_marker": "high_bailiff"}, {"has_marker": "river_bailiff"}]}, effects=[{"set_flag": {"flag": "reach_garrison_escort_active", "value": True}}, {"modify_stamina": 2}, {"log_event": "Iron Guard sentries saluted your municipal credentials."}], result_text="Iron Guard sentries salute your municipal badge. They guide you past the freezing wind gap."),
    ...
    scenes["reach_iron_spire_quarters"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="reach_spire_discharge_crags", label="Discharge Apex Power", category="systemic", condition={"all_of": [{"flag_is": {"flag": "reach_escalation_completed", "value": True}}, {"lacks_flag": "reach_dilemma_resolved"}]}, effects=[{"set_flag": {"flag": "reach_diverted_to_gorge", "value": True}}, {"set_flag": {"flag": "reach_dilemma_resolved", "value": True}}, {"modify_reputation": {"faction": "storm_wardens", "value": 15}}, {"modify_reputation": {"faction": "cliff_clans", "value": -15}}, {"log_event": "You discharged the Spire surge into the lower gorge to clear the pass."}], result_text="You throw the master switch. Blinding lightning surges down the gorge and shatters rocks."),
            Action(id="reach_spire_short_circuit", label="Short Ground Grid", category="systemic", condition={"all_of": [{"flag_is": {"flag": "reach_escalation_completed", "value": True}}, {"lacks_flag": "reach_dilemma_resolved"}]}, effects=[{"set_flag": {"flag": "reach_spire_ground_shorted", "value": True}}, {"set_flag": {"flag": "reach_dilemma_resolved", "value": True}}, {"modify_reputation": {"faction": "cliff_clans", "value": 15}}, {"modify_reputation": {"faction": "storm_wardens", "value": -15}}, {"log_event": "You shorted the Spire battery grid, saving the clan valley."}], result_text="You drive iron pitons into the battery cell. The lightning barrier collapses in sparks."),
    ...
    scenes["reach_wind_hollow_quarters"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="reach_wind_inspect_cable", label="Inspect Severed Cable", category="interaction", condition={"all_of": [{"lacks_flag": "reach_discovery_completed"}, {"any_of": [{"min_attribute": {"attribute": "perception", "value": 12}}, {"min_skill": {"skill": "cunning", "value": 2}}, {"has_trait": "keen_eyed"}]}]}, effects=[{"set_flag": {"flag": "reach_cable_inspected", "value": True}}, {"set_flag": {"flag": "reach_discovery_completed", "value": True}}, {"modify_reputation": {"faction": "cliff_clans", "value": 5}}, {"log_event": "You discovered clean copper shears with monastic markings."}], result_text="You inspect the severed copper cable. Clean shear marks reveal monk tools."),
            Action(id="reach_wind_parley_scout", label="Confront Clan Scout", category="social", condition={"lacks_flag": "reach_discovery_completed"}, effects=[{"set_flag": {"flag": "reach_scout_allied", "value": True}}, {"set_flag": {"flag": "reach_discovery_completed", "value": True}}, {"modify_reputation": {"faction": "cliff_clans", "value": 10}}, {"log_event": "You allied with the clan scout in Windy Gorge."}], result_text="The mountain scout lowers his bow. He explains how Warden power surges cause rockslides."),
    ...
    scenes["reach_secret_shrine"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="reach_shrine_harmonize_vents", label="Harmonize Ridge Vents", category="trait_exploit", condition={"all_of": [{"flag_is": {"flag": "reach_escalation_completed", "value": True}}, {"lacks_flag": "reach_dilemma_resolved"}, {"any_of": [{"has_trait": "storm_caller"}, {"min_skill": {"skill": "channeling", "value": 2}}, {"min_attribute": {"attribute": "agility", "value": 14}}, {"has_item": "shock_stone"}]}]}, effects=[{"set_flag": {"flag": "reach_vents_harmonized", "value": True}}, {"set_flag": {"flag": "reach_dilemma_resolved", "value": True}}, {"modify_reputation": {"faction": "storm_wardens", "value": 15}}, {"modify_reputation": {"faction": "cliff_clans", "value": 15}}, {"log_event": "You safely vented the galvanic surge into geothermal fissures."}], result_text="You channel the excess charge into volcanic steam vents. The storm eases into warm mist."),
    ...
    scenes["reach_watch_ruin_sanctum"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="reach_watch_snatch_capacitor", label="Snatch Capacitor Core", category="interaction", condition={"all_of": [{"flag_is": {"flag": "reach_discovery_completed", "value": True}}, {"lacks_flag": "reach_escalation_completed"}, {"any_of": [{"min_skill": {"skill": "stealth", "value": 3}}, {"has_trait": "shadow_cloaked"}, {"has_trait": "light_fingers"}]}]}, effects=[{"set_flag": {"flag": "reach_capacitor_stolen", "value": True}}, {"set_flag": {"flag": "reach_escalation_completed", "value": True}}, {"modify_reputation": {"faction": "cliff_clans", "value": 15}}, {"modify_reputation": {"faction": "storm_wardens", "value": -15}}, {"add_item": "galvanic_capacitor_core"}, {"log_event": "You stole the galvanic capacitor from the Warden watchtower."}], result_text="You slip past the monks and take the charged capacitor core from its altar cradle."),
    ...
    scenes["reach_signal_crag_overlook"] = SceneNode(
        ...
        base_actions=[
            ...
            Action(id="reach_signal_splice_wire", label="Splice Ground Wire", category="item_affordance", condition={"all_of": [{"lacks_flag": "reach_discovery_completed"}, {"any_of": [{"has_item": "crowbar"}, {"has_item": "shock_stone"}, {"min_skill": {"skill": "channeling", "value": 2}}]}]}, effects=[{"set_flag": {"flag": "reach_circuit_grounded", "value": True}}, {"set_flag": {"flag": "reach_discovery_completed", "value": True}}, {"modify_reputation": {"faction": "storm_wardens", "value": 10}}, {"log_event": "You spliced and grounded the high bluff conductor cable."}], result_text="You splice the broken wire with iron clips. Blue sparks ground harmlessly into bedrock."),
