...
- **`GET /api/game/forge`**: Continental runeforges, ancient crucibles, metallurgical masteries, and artificer rank progression.
- **`GET /api/game/elixirs`**: Continental alchemical laboratories, distillation alembics, brewed elixirs, and master apothecary rank progression.
- **`GET /api/game/orrery`**: Continental celestial orreries, astrolabe spheres, astral lens masteries, and master stargazer rank progression.
- **`GET /api/game/scriptorium`**: Continental scriptoriums, illuminator desks, illuminated manuscripts, and master calligrapher rank progression.
...
- **Continental Scriptoriums, Illuminator Desks & Master Calligrapher System (`✒️ Scribe`, Key: `S`):** 6 Canonical Ancient Scriptorium Desks situated at regional quarters complexes and crossroads (Glacial Chronicle Desk, Sunfire Papyrus Scriptorium, Abyssal Vellum Scriptorium, Palatine Imperial Scriptoria, Lowlands Notary Bureau, Grand Sovereign Scriptorium). Features 7-axis scribal affordances (quills, ink, traits, attributes $\ge 14$, skills, stamina) granting unique illuminated manuscripts and regional scribal masteries (+3 stamina). Players can recite manuscripts anywhere in the field (+3 stamina), return to quarters desks to renew calligraphy ink and clean brass seals (+2 stamina), and advance through Calligrapher Rank progression (Novice Copyist, Apprentice Scribe, Illuminator Craftsman, Master Calligrapher, Charter Chancellor, High Archivist, Continental Grandmaster Scribe) with a dedicated HUD modal, hotkey `S`, and live scriptorium counter.
- **Continental Celestial Orreries, Astrolabe Spheres & Master Stargazer System (`✨ Orrery`, Key: `A`):** 6 Canonical Ancient Celestial Orreries situated at regional high chambers and crossroads (Glacial Astrolabe Chamber, Solar Zenith Astrolabe, Abyssal Prism Astrolabe, Palatine Star Chamber, Tidebell Meridian Chamber, Grand Sovereign Orrery). Features 7-axis astronomical affordances (astrolabes, star charts, traits, attributes $\ge 14$, skills, stamina) granting unique astral lens attunements and regional celestial masteries (+3 stamina). Players can attune constellations anywhere in the field (+3 stamina), return to high chambers to recalibrate armillary sphere bearings (+2 stamina), and advance through Stargazer Rank progression (Novice Gazer, Apprentice Astrologer, Constellation Seeker, Astromancer, Master Stargazer, High Astrologian, Grand Royal Stargazer) with a dedicated HUD modal, hotkey `A`, and live orrery counter.
- **Continental Alchemical Laboratories, Distillation Alembics & Grand Master Apothecary System (`🧪 Elixirs`, Key: `E`):** 6 Canonical Ancient Alembic Laboratories situated at regional cellars and crossroads (Glacial Distillation Alembic, Solar Essence Alembic, Bioluminescent Tidal Alembic, Palatine Ducal Apothecary, Saltmarsh Distillation Still, Grand Sovereign Pharmacopeia). Features 7-axis apothecary affordances (glassware, tools, traits, attributes $\ge 14$, skills, stamina) granting unique brewed elixirs and regional pharmacopeia masteries (+3 stamina). Players can imbibe elixirs anywhere in the field (+3 stamina), return to cellar laboratories to refill and replenish alembic condensers (+2 stamina), and advance through Apothecary Rank progression (Novice Herbalist, Journeyman Brewer, Tincture Craftsman, Master Alchemist, Guild Toxicologist, Grand Pharmacist, Continental Arch-Apothecary) with a dedicated HUD modal, hotkey `E`, and live elixir counter.
- **Continental Runeforges, Ancient Crucible Anvils & Master Artificer System (`⚒️ Forge`, Key: `F`):** 6 Canonical Ancient Runeforges situated at regional armories and crossroads (Glacial Frost Anvil, Solar Crucible Anvil, Abyssal Tide Anvil, Palatine Ducal Anvil, Harbor Bell Foundry, Grand Sovereign Foundry). Features 7-axis metalworking affordances (hammers, tools, traits, attributes $\ge 14$, skills, stamina) granting unique forged runes and regional smithing masteries (+3 stamina). Players can temper runes anywhere in the field (+3 stamina), return to armory crucibles to quench masterwork blades (+2 stamina), and advance through Artificer Rank progression (Apprentice Striker, Journeyman Smith, Anvil Craftsman, Master Artificer, Guild Metallurgist, Grand Anvilmaster, Continental Forgemaster) with a dedicated HUD modal and live forge counter.
...
- **Hotkeys:** `1`–`9` (action selection), `Q` (quest journal), `P` (party & companions), `H` (bestiary & apex hunts), `K` (survival camp & foraging), `O` (faction orders & war banners), `G` (ancient shrines & divine blessings), `L` (survey landmarks & panoramas), `V` (dungeon vaults & crypt keystones), `F` (runeforges & crucible anvils), `E` (alchemical laboratories & elixirs), `A` (celestial orreries & astrolabes), `S` (scriptoriums & illuminated manuscripts), `X` (ancient codex), `T` (commodity exchange), `W` (weather forecast), `B` (mercenary contracts), `M` (continental map), `C` (character sheet), `U` (undo), `Escape` (close modals).

### CLI Player Features & Deterministic Replay
```bash
# Interactive play with 7-axis sheet ('sheet'), quest log ('quest'), companions ('party'), bestiary ('hunt'), survival camp ('camp'/'cook'/'rations'), orders ('orders'/'banners'), shrines ('shrines'/'blessings'), orrery ('orrery'/'astrolabe'/'stars'), scribe ('scribe'/'scrolls'/'manuscripts'), codex ('codex'), trade ('trade'), weather ('weather'), bounties ('bounties'), and undo ('u')
python3 -m adventure_forge.player.cli [preset]
